...
Останавливать SSClash **перед обновлением не обязательно**. Если загрузка с GitHub не удалась при работающем ssclash — установщик остановит сервис один раз и повторит. Отключить: `--keep-running`.
